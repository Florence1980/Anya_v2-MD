...
module.exports = {
     ...
     */
    ownername: process.env.Owner_Name || "AGRIPPA",
    ownernumber: process.env.Owner_Number || "260-779303776",
    ...
    sessionId: process.env.SESSION_ID || "rXB_A_N_Y_A_V_2_te4VNP2j5dA0MCkar",
